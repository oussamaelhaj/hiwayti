...
export const colors = {
  ...
  // Chart & data viz
  chart: ['#C9A84C', '#1DD6C3', '#3D94F6', '#22D98A', '#FF4C6B', '#FFA940', '#9B59B6', '#FF8CC8'],
};
...
export const CATEGORIES = [
  { id: 'surf',     labelFr: 'Surf',          labelAr: 'ركوب الأمواج', icon: 'water',       color: colors.surf,    emoji: '🏄' },
  { id: 'padel',    labelFr: 'Padel',          labelAr: 'بادل',         icon: 'tennisball',  color: colors.padel,   emoji: '🎾' },
  { id: 'hiking',   labelFr: 'Randonnée',      labelAr: 'المشي',        icon: 'trail-sign',  color: colors.hiking,  emoji: '🏔️' },
  { id: 'pottery',  labelFr: 'Poterie',        labelAr: 'الفخار',       icon: 'color-palette', color: colors.pottery, emoji: '🏺' },
  { id: 'leather',  labelFr: 'Maroquinerie',   labelAr: 'الجلد',        icon: 'briefcase',   color: colors.leather, emoji: '👜' },
  { id: 'textiles', labelFr: 'Textiles',       labelAr: 'النسيج',       icon: 'shirt',       color: colors.textiles,emoji: '🧵' },
  { id: 'cuisine',  labelFr: 'Gastronomie',    labelAr: 'الطهي',        icon: 'restaurant',  color: colors.cuisine, emoji: '🍽️' },
  { id: 'music',    labelFr: 'Musique',        labelAr: 'الموسيقى',     icon: 'musical-notes',color: colors.music,  emoji: '🎵' },
];
